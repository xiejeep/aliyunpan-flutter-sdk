...
class AlbumFileStreamsUrl {
  /// LIVP 静态图片。服务端仅返回 HEIC 或 JPEG 其中一种。
  final String? heic;

  /// LIVP 静态 JPEG 图片。与 [heic] 不会同时返回。
  final String? jpeg;

  /// livp动画
  final String? mov;

  const AlbumFileStreamsUrl({this.heic, this.jpeg, this.mov});

  factory AlbumFileStreamsUrl.fromJson(Map<String, dynamic> json) =>
      AlbumFileStreamsUrl(
        heic: json['heic'] as String?,
        jpeg: json['jpeg'] as String?,
